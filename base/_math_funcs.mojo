...
fn _math_func_1_tensor_in_one_tensor_out[dtype:DType, func: fn[type:DType, simd_w:Int](SIMD[type, simd_w]) -> SIMD[type, simd_w]](tensor: Tensor[dtype])->Tensor[dtype]:
    """
...
fn _math_func_2_tensor_in_one_tensor_out[dtype:DType, func: fn[type:DType, simd_w:Int](SIMD[type, simd_w],SIMD[type, simd_w]) -> SIMD[type, simd_w]](tensor1: Tensor[dtype], tensor2: Tensor[dtype])raises->Tensor[dtype]:
...
fn _math_func_compare_2_tensors[dtype:DType, func: fn[type:DType, simd_w:Int](SIMD[type, simd_w],SIMD[type, simd_w]) -> SIMD[DType.bool, simd_w]](tensor1: Tensor[dtype], tensor2: Tensor[dtype])raises->Tensor[DType.bool]:
    if tensor1.shape() != tensor2.shape():
        with assert_raises():
            raise "Shape Mismatch error shapes must match for this function"
