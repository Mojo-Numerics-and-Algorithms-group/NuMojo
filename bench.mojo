...
fn main() raises:
    var tens1: NDArray[DType.float32] = NDArray[DType.float32](VariadicList[Int](2, 2), random=True)
    var tens2: NDArray[DType.float32] = NDArray[DType.float32](VariadicList[Int](2, 2), random=True)
    var tens3: NDArray[DType.float32] = NDArray[DType.float32](VariadicList[Int](2, 2), random=True)
    ...
    var res:NDArray[DType.float32] = NDArray[DType.float32](VariadicList[Int](2, 2))

    print(add[DType.float32,backend=backend](tens1, tens2))
    print(sub[DType.float32,backend=backend](tens1, tens2))
    print(mul[DType.float32,backend=backend](tens1, tens2))
    print(div[DType.float32,backend=backend](tens1, tens2))
