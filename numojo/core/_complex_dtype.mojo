...
struct ComplexSIMD[dtype: DType, size: Int = 1]():
    var re: SIMD[dtype, size]
    var im: SIMD[dtype, size]

    alias ci16 = ComplexSIMD[DType.int16, 1]
    alias ci32 = ComplexSIMD[DType.int32, 1]
    alias ci64 = ComplexSIMD[DType.int64, 1]
    alias cu8 = ComplexSIMD[DType.uint8, 1]
    alias cu16 = ComplexSIMD[DType.uint16, 1]
    alias cu32 = ComplexSIMD[DType.uint32, 1]
    alias cu64 = ComplexSIMD[DType.uint64, 1]
    alias cf16 = ComplexSIMD[DType.float16, 1]
    alias cf32 = ComplexSIMD[DType.float32, 1]
    alias cf64 = ComplexSIMD[DType.float64, 1]
    ...
    # keep it limited for now
    fn __add__(self, other: SIMD[dtype, size]) -> Self:
    ...
    fn __iadd__(mut self, other: SIMD[dtype, size]):
        self.re += other
        self.im += other
    ...
    fn __sub__(self, other: SIMD[dtype, size]) -> Self:
        return Self(self.re - other, self.im + other)
    ...
    fn __isub__(mut self, other: SIMD[dtype, size]):
        self.re -= other
        self.im -= other
    ...
    fn __mul__(self, other: SIMD[dtype, size]) -> Self:
        return Self(self.re * other, self.im * other)
    ...
    fn __imul__(mut self, other: SIMD[dtype, size]):
        self.re *= other
        self.im *= other
    ...
    fn __truediv__(self, other: SIMD[dtype, size]) -> Self:
        return Self(self.re / other, self.im / other)
    ...
    fn __itruediv__(mut self, other: SIMD[dtype, size]):
        self.re /= other
        self.im /= other
    ...
    fn __hash__[H: _Hasher](self, mut hasher: H):
        hasher._update_with_simd(self.re)
        hasher._update_with_simd(self.im)
    ...
    fn __setitem__(mut self, idx: Int, value: Self):
        self.re = value.re
        self.im = value.im
...
struct CDType(
    ...
    var value: Self.type
    """The underlying storage for the CDType value."""

    alias invalid = CDType(
        __mlir_attr.`#kgen.dtype.constant<invalid> : !kgen.dtype`
    )
    """Represents an invalid or unknown data type."""
    alias bool = CDType(__mlir_attr.`#kgen.dtype.constant<bool> : !kgen.dtype`)
    """Represents a boolean data type."""
    alias int8 = CDType(__mlir_attr.`#kgen.dtype.constant<si8> : !kgen.dtype`)
    """Represents a signed integer type whose bitwidth is 8."""
    alias uint8 = CDType(__mlir_attr.`#kgen.dtype.constant<ui8> : !kgen.dtype`)
    """Represents an unsigned integer type whose bitwidth is 8."""
    alias int16 = CDType(__mlir_attr.`#kgen.dtype.constant<si16> : !kgen.dtype`)
    ...
    alias int32 = CDType(__mlir_attr.`#kgen.dtype.constant<si32> : !kgen.dtype`)
    ...
    alias int64 = CDType(__mlir_attr.`#kgen.dtype.constant<si64> : !kgen.dtype`)
    ...
    fn sizeof(self) -> Int:
        ...
        if self == CDType.bool:
            return sizeof[CDType.bool]()
        if self == CDType.index:
            return sizeof[CDType.index]()
        if self == CDType.float8e5m2:
            return sizeof[CDType.float8e5m2]()
        if self == CDType.float8e5m2fnuz:
            return sizeof[CDType.float8e5m2fnuz]()
        if self == CDType.float8e4m3:
            return sizeof[CDType.float8e4m3]()
        if self == CDType.float8e4m3fnuz:
            return sizeof[CDType.float8e4m3fnuz]()
        if self == CDType.bfloat16:
            return sizeof[CDType.bfloat16]()
        if self == CDType.float16:
            return sizeof[CDType.float16]()
        if self == CDType.float32:
            return sizeof[CDType.float32]()
        if self == CDType.tensor_float32:
            return sizeof[CDType.tensor_float32]()
        if self == CDType.float64:
            return sizeof[CDType.float64]()
        return sizeof[CDType.invalid]()
...
#     alias invalid = CDType(
#         __mlir_attr.`#kgen.dtype.constant<invalid> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<invalid> : !kgen.dtype`
#     )
#     """Represents an invalid or unknown data type."""
#     alias bool = CDType(__mlir_attr.`#kgen.dtype.constant<bool> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<bool> : !kgen.dtype`)
#     """Represents a boolean data type."""
#     alias int8 = CDType(__mlir_attr.`#kgen.dtype.constant<si8> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<si8> : !kgen.dtype`)
#     """Represents a signed integer type whose bitwidth is 8."""
#     alias uint8 = CDType(__mlir_attr.`#kgen.dtype.constant<ui8> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<ui8> : !kgen.dtype`)
#     """Represents an unsigned integer type whose bitwidth is 8."""
#     alias int16 = CDType(__mlir_attr.`#kgen.dtype.constant<si16> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<si16> : !kgen.dtype`)
#     """Represents a signed integer type whose bitwidth is 16."""
#     alias uint16 = CDType(__mlir_attr.`#kgen.dtype.constant<ui16> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<ui16> : !kgen.dtype`)
#     """Represents an unsigned integer type whose bitwidth is 16."""
#     alias int32 = CDType(__mlir_attr.`#kgen.dtype.constant<si32> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<si32> : !kgen.dtype`)
#     """Represents a signed integer type whose bitwidth is 32."""
#     alias uint32 = CDType(__mlir_attr.`#kgen.dtype.constant<ui32> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<ui32> : !kgen.dtype`)
#     """Represents an unsigned integer type whose bitwidth is 32."""
#     alias int64 = CDType(__mlir_attr.`#kgen.dtype.constant<si64> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<si64> : !kgen.dtype`)
#     """Represents a signed integer type whose bitwidth is 64."""
#     alias uint64 = CDType(__mlir_attr.`#kgen.dtype.constant<ui64> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<ui64> : !kgen.dtype`)
#     """Represents an unsigned integer type whose bitwidth is 64."""
#     alias bfloat16 = CDType(
#         __mlir_attr.`#kgen.dtype.constant<bf16> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<bf16> : !kgen.dtype`
#     )
#     """Represents a brain floating point value whose bitwidth is 16."""
#     alias float16 = CDType(__mlir_attr.`#kgen.dtype.constant<f16> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<f16> : !kgen.dtype`)
#     """Represents an IEEE754-2008 `binary16` floating point value."""
#     alias float32 = CDType(__mlir_attr.`#kgen.dtype.constant<f32> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<f32> : !kgen.dtype`)
#     """Represents an IEEE754-2008 `binary32` floating point value."""
#     alias float64 = CDType(__mlir_attr.`#kgen.dtype.constant<f64> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<f64> : !kgen.dtype`)
#     """Represents an IEEE754-2008 `binary64` floating point value."""
#     alias index = CDType(__mlir_attr.`#kgen.dtype.constant<index> : !kgen.dtype`, __mlir_attr.`#kgen.dtype.constant<index> : !kgen.dtype`)
#     """Represents an integral type whose bitwidth is the maximum integral value
#     on the system."""
...
#     @always_inline
#     fn __init__(out self, re: Self.type, im: Self.type):
#         """Construct a CDType from MLIR dtype.

#         Args:
#             re: The real part of the CDType.
#             im: The imaginary part of the CDType.
#         """
#         self.re = re
#         self.im = im
...
#     @staticmethod
#     fn _from_ui8(ui8: __mlir_type.ui8) -> CDType:
#         return CDType(__mlir_op.`pop.dtype.from_ui8`(ui8), __mlir_op.`pop.dtype.from_ui8`(ui8))
...
#         self,
#     ) -> __mlir_type.`!pop.scalar<ui8>`:
#         var real = __mlir_op.`pop.dtype.to_ui8`(self.re)
#         return __mlir_op.`pop.cast_from_builtin`[
#             _type = __mlir_type.`!pop.scalar<ui8>`
#         ](real)
...
#         self,
#     ) -> __mlir_type.`!pop.scalar<ui8>`:
#         var imag = __mlir_op.`pop.dtype.to_ui8`(self.im)
#         return __mlir_op.`pop.cast_from_builtin`[
#             _type = __mlir_type.`!pop.scalar<ui8>`
#         ](imag)
...
#             True if the DTypes are the same and False otherwise.
#         """
#         var temp: Bool = __mlir_op.`pop.cmp`[pred = __mlir_attr.`#pop<cmp_pred eq>`](
#             self._as_i8_re(), rhs._as_i8_re()
#         )
#         var temp1: Bool = __mlir_op.`pop.cmp`[pred = __mlir_attr.`#pop<cmp_pred eq>`](
#             self._as_i8_im(), rhs._as_i8_im()
#         )
#         return temp and temp1
...
#             False if the DTypes are the same and True otherwise.
#         """
#         var temp: Bool = __mlir_op.`pop.cmp`[pred = __mlir_attr.`#pop<cmp_pred ne>`](
#             self._as_i8_re(), rhs._as_i8_re()
#         )
#         var temp1: Bool = __mlir_op.`pop.cmp`[pred = __mlir_attr.`#pop<cmp_pred ne>`](
#             self._as_i8_im(), rhs._as_i8_im()
#         )
#         return temp and temp1
...
#             A 64-bit integer hash of this `CDType` value.
#         """
#         return hash(UInt8(self._as_i8_re()))
...
#             hasher: The hasher instance.
#         """
#         hasher._update_with_simd(UInt8(self._as_i8_re()))
...
#         return Bool(
#             __mlir_op.`pop.cmp`[pred = __mlir_attr.`#pop<cmp_pred ne>`](
#                 __mlir_op.`pop.simd.and`(self._as_i8_re(), _mIsInteger.value),
#                 UInt8(0).value,
#             )
#         )
...
#         return Bool(
#             __mlir_op.`pop.cmp`[pred = __mlir_attr.`#pop<cmp_pred ne>`](
#                 __mlir_op.`pop.simd.and`(self._as_i8_re(), _mIsFloat.value),
#                 UInt8(0).value,
#             )
#         )
...
#                             __mlir_op.`pop.shr`(
#                                 __mlir_op.`pop.simd.and`(
#                                     self._as_i8_re(), _mIsNotInteger.value
#                                 ),
#                                 UInt8(1).value,
#                             ),
#                             UInt8(3).value,
