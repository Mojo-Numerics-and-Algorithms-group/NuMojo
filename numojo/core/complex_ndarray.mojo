...
struct ComplexNDArray[
    ...
    fn __init__(
        ...
        """
        self.re.__init__(ndim, offset, size, shape, strides, order)
        self.im.__init__(ndim, offset, size, shape, strides, order)
    ...
    fn __init__(
        ...
        Extremely specific NDArray initializer.
        """
        self.re.__init__(data_re, ndim, offset, shape, strides, order)
        self.im.__init__(data_im, ndim, offset, shape, strides, order)
