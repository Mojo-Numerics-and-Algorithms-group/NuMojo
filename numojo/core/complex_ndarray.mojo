...
#     is_mutable: Bool, //,
#     re_origin: Origin[is_mutable],
#     im_origin: Origin[is_mutable],
#     cdtype: CDType,
#     dtype: DType,
#     forward: Bool = True,
# ]:
...
#         re_origin: The lifetime of the underlying NDArray data.
#         im_origin: The lifetime of the underlying NDArray data.
