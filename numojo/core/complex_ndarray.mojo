...
from numojo.core._complex_dtype import ComplexSIMD, ComplexScalar
...
struct ComplexNDArray[
    intype: CDType = CDType.float64,  dtype: DType = intype.eq()
    ...
    fn set(self, owned index: Int, val: ComplexSIMD[dtype, 1]) raises:
        """
        ...
        if index < 0:
            index += self.real.size

        if (index >= self.real.size) or (index < 0):
            raise Error(
    ...
    fn _setitem(self, *indices: Int, val: ComplexSIMD[dtype, 1]):
        """
        ...
        for i in range(self.real.ndim):
            index_of_buffer += indices[i] * self.real.strides._buf[i]
    ...
    # ===-------------------------------------------------------------------===#
    fn get(self, owned index: Int) raises -> ComplexScalar[dtype]:
        """
        Safely retrieve i-th item from the underlying buffer.
        ...
        return ComplexScalar[dtype](self.re._buf[index], self.im._buf[index])
    ...
    @always_inline("nodebug")
    fn __eq__(self, other: ComplexScalar[dtype]) raises -> NDArray[DType.bool]:
        """
    ...
    @always_inline("nodebug")
    fn __ne__(self, other: ComplexScalar[dtype]) raises -> NDArray[DType.bool]:
        """
        Itemwise non-equivalence between scalar and Array.
        """
        return comparison.not_equal[dtype](
            self.re, other.re
        ) and comparision.not_equal[dtype](self.im, other.im)

    fn __add__(self, other: ComplexScalar[dtype]) raises -> Self:
        """
    ...
    fn __radd__(mut self, other: ComplexScalar[dtype, 1]) raises -> Self:
        """
    ...
    fn __iadd__(mut self, other: ComplexScalar[dtype, 1]):
        """
        Enables `array += scalar`.
        """
        self.re += other.re
    ...
    fn __sub__(self, other: ComplexScalar[dtype]) raises -> Self:
        """
        Enables `array + scalar`.
        """
    ...
    fn __rsub__(mut self, other: ComplexScalar[dtype]) raises -> Self:
        """
        Enables `scalar + array`.
        """
        var real: NDArray[dtype] = math.sub[dtype](self.re, other.re)
    ...
    fn __isub__(mut self, other: ComplexScalar[dtype]):
        """
        Enables `array += scalar`.
        """
        self.re -= other.re
    ...
    fn __mul__(self, other: ComplexScalar[dtype]) raises -> Self:
        """
        Enables `array * scalar`.
        """
   ...
   # ===-------------------------------------------------------------------===#
    ...
    fn __repr__(self) -> String:
        ...
        """
        try:
            var result: String = str("ComplexNDArray[CDType.") + str(self.dtype) + str(
                "](List[Scalar[DType."
            ) + str(self.dtype) + str("]](")
            if self.re.size > 6:
                for i in range(6):
...
# struct ComplexNDArrayanother[dtype: DType = DType.float64](
#     Stringable, Representable, CollectionElement, Sized, Writable
# ):
...
#     var _buf: UnsafePointer[ComplexSIMD[dtype, 1]]
...
#         self._buf = UnsafePointer[ComplexSIMD[dtype, 1]]().alloc(self.size)
#         self.datatype = dtype
#         self.order = order
...
#     fn __init__(
#         mut self,
#         data: UnsafePointer[ComplexSIMD[dtype, 1]],
#         ndim: Int,
#         offset: Int,
#         shape: List[Int],
#         strides: List[Int],
...
#     fn __setitem__(mut self, index: Idx, val: ComplexSIMD[dtype, 1]) raises:
#         """
...
#     fn __setitem__(
#         mut self, mask: NDArray[DType.bool], value: ComplexSIMD[dtype, 1]
#     ) raises:
#         """
...
#             self.set(int(index.get(i)), rebind[ComplexSIMD[dtype, 1]](val.get(i)))
...
#     # Getter dunders and other getter methods
#     # ===-------------------------------------------------------------------===#
#     fn get(self, owned index: Int) raises -> ComplexSIMD[dtype, 1]:
#         """
#         Safely retrieve i-th item from the underlying buffer.
...
#     fn _getitem(self, *indices: Int) -> ComplexSIMD[dtype, 1]:
#         """
#         (UNSAFE! for internal use only.)
#         Get item at indices and bypass all boundary checks.
...
#     fn __getitem__(self, index: Idx) raises -> ComplexSIMD[dtype, 1]:
#         """
#         Set the value at the index list.
#         """
#         if index.__len__() != self.ndim:
...
#                 "ndarray:NDArrray:__pos__: pos does not accept bool type arrays"
#             )
#         return self * ComplexSIMD[dtype, 1](-1.0)
...
#     @always_inline("nodebug")
#     fn __eq__(self, other: ComplexSIMD[dtype, 1]) raises -> NDArray[DType.bool]:
#         """
#         Itemwise equivelence between scalar and Array.
#         """
#         return comparison.equal[dtype](self, other)
...
#     @always_inline("nodebug")
#     fn __ne__(self, other: ComplexSIMD[dtype, 1]) raises -> NDArray[DType.bool]:
#         """
...
#     @always_inline("nodebug")
#     fn __lt__(self, other: ComplexSIMD[dtype, 1]) raises -> NDArray[DType.bool]:
#         """
#         Itemwise less than.
#         """
...
#     @always_inline("nodebug")
#     fn __le__(self, other: ComplexSIMD[dtype, 1]) raises -> NDArray[DType.bool]:
#         """
...
#     @always_inline("nodebug")
#     fn __gt__(self, other: ComplexSIMD[dtype, 1]) raises -> NDArray[DType.bool]:
#         """
...
#     @always_inline("nodebug")
#     fn __ge__(self, other: ComplexSIMD[dtype, 1]) raises -> NDArray[DType.bool]:
#         """
...
#     fn __add__(self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `array + scalar`.
#         """
...
#     fn __radd__(mut self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `scalar + array`.
#         """
#         return math.add[dtype](self, other)
...
#     fn __iadd__(mut self, other: ComplexSIMD[dtype, 1]) raises:
#         """
#         Enables `array += scalar`.
#         """
...
#     fn __sub__(self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `array - scalar`.
#         """
...
#     fn __rsub__(mut self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `scalar - array`.
#         """
#         return math.sub[dtype](other, self)

#     fn __isub__(mut self, other: ComplexSIMD[dtype, 1]) raises:
#         """
#         Enables `array -= scalar`.
#         """
#         self = self - other
...
#     fn __mul__(self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `array * scalar`.
#         """
#         return math.mul[dtype](self, other)
...
#     fn __rmul__(mut self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `scalar * array`.
#         """
#         return math.mul[dtype](self, other)

#     fn __imul__(mut self, other: ComplexSIMD[dtype, 1]) raises:
#         """
#         Enables `array *= scalar`.
#         """
#         self = self * other
...
#     fn __truediv__(self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `array / scalar`.
#         """
...
#     fn __itruediv__(mut self, s: ComplexSIMD[dtype, 1]) raises:
#         """
#         Enables `array /= scalar`.
#         """
...
#     fn __rtruediv__(self, s: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `scalar / array`.
#         """
...
#     fn __floordiv__(self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `array // scalar`.
#         """
...
#     fn __ifloordiv__(mut self, s: ComplexSIMD[dtype, 1]) raises:
#         """
#         Enables `array //= scalar`.
#         """
...
#     fn __rfloordiv__(self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `scalar // array`.
#         """
...
#     fn __mod__(mut self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `array % scalar`.
#         """
...
#     fn __imod__(mut self, other: ComplexSIMD[dtype, 1]) raises:
#         """
#         Enables `array %= scalar`.
#         """
...
#     fn __rmod__(mut self, other: ComplexSIMD[dtype, 1]) raises -> Self:
#         """
#         Enables `scalar % array`.
#         """
...
#     fn vdot(self, other: Self) raises -> ComplexSIMD[dtype, 1]:
#         """
...
#         """
#         var result: Int = 0
#         var max_val: ComplexSIMD[dtype, 1] = self.load[width=1](0)
#         for i in range(1, self.size):
#             var temp: ComplexSIMD[dtype, 1] = self.load[width=1](i)
#             if temp > max_val:
#                 max_val = temp
#                 result = i
#         return result
...
#         """
#         var result: Int = 0
#         var min_val: ComplexSIMD[dtype, 1] = self.load[width=1](0)
#         for i in range(1, self.size):
#             var temp: ComplexSIMD[dtype, 1] = self.load[width=1](i)
#             if temp < min_val:
#                 min_val = temp
...
#     fn fill(mut self, val: ComplexSIMD[dtype, 1]):
#         """
...
#     fn item(self, *index: Int) raises -> ComplexSIMD[dtype, 1]:
#         """
...
#     fn itemset(
#         mut self, index: Variant[Int, List[Int]], item: ComplexSIMD[dtype, 1]
#     ) raises:
...
#     fn mean(self) raises -> ComplexSIMD[dtype, 1]:
#         """
...
#     fn prod(self: Self) raises -> ComplexSIMD[dtype, 1]:
#         """
...
#     fn sum(self: Self) raises -> ComplexSIMD[dtype, 1]:
#         """
...
#     fn tolist(self) -> List[ComplexSIMD[dtype, 1]]:
#         """
...
#             A 1-D List.
#         """
#         var result: List[ComplexSIMD[dtype, 1]] = List[ComplexSIMD[dtype, 1]]()
#         for i in range(self.size):
...
#     fn unsafe_ptr(self) -> UnsafePointer[ComplexSIMD[dtype, 1]]:
#         """
