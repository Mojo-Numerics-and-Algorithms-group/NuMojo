...
struct Array[dtype: DType = DType.float32](Stringable):
    ...
    fn __getitem__(self, *indices: Int) raises -> SIMD[dtype,1]:
        ...
        var index:Int = self._arrayInfo.first_index 
    ...
    fn _elementwise_scalar_arithmetic[
        ...
        @parameter
        fn elemwise_vectorize[simd_width: Int](idx: Int):
            new_array._arr.store[width=simd_width](idx, 
                func[dtype, simd_width](SIMD[dtype, 
                simd_width](s), 
    ...
    fn _elementwise_array_arithmetic[
            func: fn[dtype: DType, width: Int](
            SIMD[dtype, width],SIMD[dtype, width])->SIMD[dtype, width]]
            (self, other: Self) -> Self:
        alias simd_width = simdwidthof[dtype]()
        var new_vec = self
        @parameter
        fn elemwise_arithmetic[simd_width:Int](index: Int):
            new_vec._arr.store[width=simd_width](index, 
                func[dtype, simd_width](self._arr.load[width=simd_width](index),
    ...
    fn _elementwise_pow(self, p: Int) -> Self:
        ...
        vectorize[tensor_scalar_vectorize, simd_width](self._arrayInfo.num_elements)
        return new_vec
