...
](A: MatrixImpl[dtype, **_]) raises -> Scalar[dtype]:
    """
...
fn max[dtype: DType](A: MatrixImpl[dtype, **_]) raises -> Scalar[dtype]:
    """
...
fn min[dtype: DType](A: MatrixImpl[dtype, **_]) raises -> Scalar[dtype]:
    """
    Find min item.
    """
