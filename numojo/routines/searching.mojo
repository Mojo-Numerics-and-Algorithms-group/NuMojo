...
](A: MatrixImpl[dtype, **_]) raises -> Scalar[DType.int, **_]:
...
fn find_extrema_index[
    dtype: DType, find_max: Bool
](A: MatrixImpl[dtype, **_], axis: Optional[Int]) raises -> Matrix[DType.int]:
    """Find index of min/max value, either in whole matrix or along an axis."""
...
fn argmax[dtype: DType](A: MatrixImpl[dtype, **_]) raises -> Scalar[DType.int]:
...
fn argmin[dtype: DType](A: MatrixImpl[dtype, **_]) raises -> Scalar[DType.int]:
    """
