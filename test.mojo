...
fn main() raises:
    var A = arange[f64](1, 10, 1)
    print(A)
    A.reshape(3, 3)
    print(A)
    print(A[1,1])
    var b = arange[f64](1, 10, 1)
    b.reshape(3, 3)
    var total = A + b
    print(total)
    # var np = Python.import_module("numpy")
    # var A = np.arange(1, 10, 1).reshape(3, 3)
    # print(A)
    # var b = np.arange(1, 10, 1).reshape(3, 3)
    # print(b)
    # var total = A + b
    # print(total)
    # print(A.load[1](1), A.load[1](2), A.load[1](3))
    # var temp = NDArray[f64](data=A)
    # print(temp)
    # temp.T()
    # print(temp)
    # var A = NDArray[i8](3, 4, random=True)
    # print(A)
    # print(trace(A, offset = 1, axis1=0, axis2=1))
    # var A = NDArray[i16](5, random=True)
    # print(A)
    # A.sort()
    # print(A)
    # var B = tri[i16](3, 5, -1)
