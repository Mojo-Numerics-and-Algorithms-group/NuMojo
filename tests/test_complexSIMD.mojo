...
from numojo.core._complex_dtype import ComplexSIMD, CDType
from numojo import *

fn test_complex_init() raises:
    """Test initialization of ComplexSIMD."""
    var c1 = ComplexSIMD[CDType.float32](1.0, 2.0) 
    assert_equal(c1.re, 1.0, "init failed")
    assert_equal(c1.im, 2.0, "init failed")

    var c2 = ComplexSIMD[CDType.float32](c1)
...
fn test_complex_add() raises:
    ...
    var c1 = ComplexSIMD[CDType.float32](1.0, 2.0)
    var c2 = ComplexSIMD[CDType.float32](3.0, 4.0)
...
fn test_complex_sub() raises:
    ...
    var c1 = ComplexSIMD[CDType.float32](3.0, 4.0)
    var c2 = ComplexSIMD[CDType.float32](1.0, 2.0)
